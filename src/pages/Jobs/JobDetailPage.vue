...
<template>
  ...
  <div class="w-[375px] min-h-[812px] mx-auto bg-white relative">
    ...
    <!-- 스크롤 영역 -->
    <main class="px-5 pb-24 space-y-4">
      <!-- 상단 카드 -->
      <section
        class="w-[335px] h-[159px] flex-shrink-0 rounded-[16px] bg-white shadow-[1px_1px_4px_rgba(0,0,0,0.25)] mx-auto px-5 py-4 mt-0.5"
      >
        <!-- 제목 -->
        <h2 class="text-[18px] font-extrabold text-[#333] leading-snug">
          {{ job.title }}
        </h2>

        <!-- 회사명 -->
        <p class="text-[15px] text-[#3D4352] mt-1">{{ job.company }}</p>

        <!-- 주소 -->
        <div class="flex items-center gap-1 mt-2 text-[14px] text-[#555]">
      ...
      <!-- 근무 조건 -->
      <section
        class="w-[335px] h-auto flex-shrink-0 rounded-[12px] bg-white shadow-[1px_1px_4px_rgba(0,0,0,0.25)] mx-auto px-5 py-4"
      >
        <!-- 근무 조건 라벨 -->
        ...
        <div class="grid grid-cols-2 ms-2 gap-2">
          ...
          <div class="flex items-start gap-2 text-gray-500">
            <svg
              ...
              viewBox="0 0 16 16"
              fill="none"
              class="w-[14px] h-[14px] flex-shrink-0 mt-1 fill-[#333]"
            >
              <path
            ...
            <div>
              <div class="text-[15px]">급여</div>
              <div class="mt-0.5 font-semibold text-[14px] text-gray-800">{{ job.wage }}</div>
            </div>
          </div>
          ...
          <div class="flex items-start gap-2 text-gray-500">
            ...
            <div>
              <div class="text-[15px]">근무시간</div>
              <div class="mt-0.5 font-semibold text-[14px] text-gray-800">{{ job.time }}</div>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 ms-2 gap-2">
          ...
          <div class="flex items-start gap-2 text-gray-500">
            <svg
              ...
              viewBox="0 0 18 18"
              fill="none"
              class="w-[14px] h-[14px] mt-1 flex-shrink-0"
            >
              <path
            ...
            <div>
              <div class="text-[15px]">근무일</div>
              <div class="mt-0.5 font-semibold text-[14px] text-gray-800">{{ job.days }}</div>
            </div>
          </div>
      ...
      <!-- 업무 내용 -->
      <section
        class="w-[335px] h-[242px] flex-shrink-0 rounded-[16px] bg-white shadow-[1px_1px_4px_rgba(0,0,0,0.25)] mx-auto px-5 py-4"
      >
        <!-- 라벨 -->
        <h3 class="text-[18px] font-bold text-[#333] font-[Inter] leading-normal mb-2">
          업무 내용
        ...
        <!-- 주요 업무 -->
        <div class="text-[15px] text-gray-700 mb-3">
          <div class="font-semibold text-[#333] mb-1 ms-1">주요 업무</div>
          <ul class="list-disc pl-5 space-y-1 ms-2">
      ...
      <section class="rounded-2xl border border-gray-200 bg-white px-5 py-4 shadow-sm">
        <h3 class="text-[18px] font-bold text-[#111] mb-2">근무 위치</h3>
        ...
        <div class="mt-3 text-[12px] text-gray-600 space-y-1">
          <div class="flex items-center gap-2">
            ...
            <span class="text-gray-700 text-[15px]">대중교통</span>
          </div>
          <div class="pl-5 text-[14px] font-bold">
            <span class="text-gray-700">버스</span>
            <span class="mx-1 text-gray-400">|</span>
            <span class="text-gray-700">{{ job.buses }}</span>
          </div>
          <div class="pl-5 text-gray-500 text-[14px]">
            {{ job.station }}
          </div>
        </div>
      </section>
      ...
      <!-- 회사 정보 -->
      <section class="rounded-2xl border border-gray-200 bg-white px-5 py-4 shadow-sm">
        <h3 class="text-[18px] font-bold text-[#111] mb-2">회사 정보</h3>

        <div class="grid grid-cols-2 gap-3 text-[14px]">
          <div class="bg-gray-50 rounded-xl p-3">
            <div class="text-gray-500">업종</div>
            <div class="font-semibold text-gray-800 mt-2">{{ job.industry }}</div>
        ...
        <p class="text-[14px] text-gray-600 mt-4 leading-5 px-2">
          {{ job.about }}
        </p>
      </section>
    </main>
