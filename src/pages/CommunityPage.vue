          ...
          <div class="mt-2 flex items-start justify-between">
            <div class="min-w-0 mx-1">
              ...
              <div class="mt-1 flex items-center gap-1">
                ...
                <p class="text-[10px] font-medium text-[#454545] leading-normal truncate">
        ...
        <ul>
          <li v-for="(p, i) in posts" :key="p.id" class="py-4">
            ...
            <div class="flex items-start gap-3">
              ...
              />
              <div class="min-w-0">
                <p class="text-[13px] font-semibold text-[#333] leading-normal truncate">
                  {{ p.name }}
                </p>
            ...
            <!-- 댓글 영역 (오른쪽 정렬 그대로) -->
            <div class="mt-2 flex items-center gap-1 justify-end text-[12px] text-[#7D7D7D]">
